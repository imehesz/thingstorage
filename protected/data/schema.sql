...
CREATE TABLE comics (created integer, cvID VARCHAR(50), id INTEGER PRIMARY KEY, name varchar(100), url VARCHAR(250), "volume" varchar(100), "description" text, "issue" INT DEFAULT 0, "year" INT DEFAULT 0, "image" VARCHAR(250));
